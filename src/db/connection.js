...
const DEV_MONGO_URI = `mongodb://localhost:27017/online-shop`;

const PROD_MONGO_URI = `mongodb+srv://${process.env.MONGO_DB_UN}:${process.env.MONGO_DB_PW}@cluster0.bqu75.mongodb.net/online-shop`;
